...
public static int MAX_INSERTION_SORT = 10;  // parameter to tune for speed
     ...
     * @param left the starting index of the array where sorting should
     * start
     * @param right the ending index
     * @return an array containing the smallest entry
     * in index 0 and the biggest number
     * in index 1 and 0 in index 2 if the array is
     * already sorted or 1 in index 2 if the array is
     * not already sorted; 0 in index 3 if it has negative entries
     * and 1 if it doesn't and finally 0 in index 4 if it has positive entries
     * and 1 if not.ty
     */
...
return new int []{smallest, biggest, 1,hasNegValue?0:1,hasPosValue?0:1};
    ...
    /**
     * 
     * @param sortJob the array to be sorted between <code>left</code> and <code>right</code>
     * @param left the index to start sorting from.
     * @param right the index to stop sorting at.
     * @return the index of the last negative number after moving all negatives to the left side of the array.
     */
...
return new double[]{smallest, biggest, 1,hasNegValue?0:1,hasPosValue?0:1};
  ...
  /**
   * 
   * @param sortJob The array to partitionFloat using suggested-index-based left-right partitioning.
   ...
   * @param partitionSteps The number of times to partitionFloat.
 This method first checks if the sub-array is sorted and its smallest and largest
 entries. ty
 If the sub-array has 100 entries or less and is already sorted, it returns the negative
 of <code>right</code> e.g. <code>-right</code>. If the sub-array has 100 entries or less
   * and is not yet sorted, it sorts it using an insertion sort algorithm and returns <code>-right</code>.
   * If the number of entries in the sub-array is greater than 100 and it is already sorted, it returns
   * <code>-right</code>. if the number of entries in the sub-array is greater than 100 and its not yet
...
/**
     ...
     * @param descr A string describing what is being printed.
     * @param arr The array whose content is to be printed.
     * @param offset The starting index in the array where printing
     * is to begin.
     * @param len The number of characters to print.
     *
     */
     ...
     * @param right The ending index where we stop sorting.
     * This method is used for small
     * array sorting by the main cluster sort code.
     *
