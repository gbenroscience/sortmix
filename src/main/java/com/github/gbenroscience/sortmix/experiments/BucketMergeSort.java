 ...
 */
 ...
 // splits array, sorts subarrays and merges subarrays into sorted array
       private static void sortArray(double []sortJob,int low, int high )                            
       {
          ...
          if ( ( high - low ) > 100000 ) // if not base case
          {
 ...
 */ 
             ...
             SpeedyBucketSort.sort(sortJob, low, high);
          }
 ...
 */ 
   ...
   // printArray("Before sorting", arr);
        double start = System.nanoTime();
         BucketMergeSort.sort(arr);//.sort(arr);
         
         start = (System.nanoTime()-start)/1.0E6;
         printObject(len+" items sorted using BucketMergeSort in "+start+"ms");     
